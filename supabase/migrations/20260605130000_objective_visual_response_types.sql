-- Visual, objective, and math response types.
...
-- Allow live text feedback on math responses.
...
begin
  ...
  if qtype not in (
    'text', 'shortAnswer', 'extendedWritten', 'structuredMultiPart',
    'annotateSource', 'mathInput', 'drawDiagram', 'photoHandwritten'
  ) then
    raise exception 'question not found';
  end if;
